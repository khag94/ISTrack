...
public class GoldOrderPageProductionTestCase extends TestBase {
	
	public static final Logger log =Logger.getLogger(GoldOrderPageProductionTestCase.class.getName());
	...
	public GoldOrderPageProductionTestCase()
	{
		super();
	}
