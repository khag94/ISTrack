...
public class ISTrackVendorBrandedServiceOrderProcessingProductionTestCase extends TestBase {
	public static final Logger log =Logger.getLogger(ISTrackVendorBrandedServiceOrderProcessingProductionTestCase.class.getName());
	...
	public ISTrackVendorBrandedServiceOrderProcessingProductionTestCase()
	{
		super();
	}
