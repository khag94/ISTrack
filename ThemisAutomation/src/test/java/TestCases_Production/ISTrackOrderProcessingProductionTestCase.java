...
public class ISTrackOrderProcessingProductionTestCase extends TestBase {
	...
	@Test(priority=3)
	public void taskRejectionByProcurementUserISTrack() throws InvalidFormatException, IOException, Throwable
	{
		log.info("################### Start login in IS Track Application ###################");
	...
	public void taskCompletionByProcurementUserISTrack() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException, ParseException
	{
		...
		log.info("################### End reject resolved process by OQMUser ###################");
		myworkpage.logOff();	
		...
		log.info("################### Start Equipment Procurement Task Completion ###################");
		taskcompletionpage.equipmentProcurement();
		log.info("################### End Equipment Procurement Task Completion ###################");
		
		log.info("####################### Start searching case ########################");
		taskcompletionpage.searchCase();
		log.info("####################### End searching case ########################");
		
		log.info("################### Start Track Supplier Delivery Task Completion ###################");
		taskcompletionpage.trackSupplierDelivery();
		log.info("################### End Track Supplier Delivery Task Completion ###################");
		
		log.info("####################### Start searching case ########################");
		taskcompletionpage.searchCase();
		log.info("####################### End searching case ########################");
		
		log.info("################### Start WareHouse Staging Task Completion ###################");
		taskcompletionpage.warehouseStaging();
		log.info("################### End WareHouse Staging Task Completion ###################");
		
		log.info("####################### Start searching case ########################");
		taskcompletionpage.searchCase();
		log.info("####################### End searching case ########################");
		
		log.info("################### Start Track WareHouse Delivery Task Completion ###################");
		taskcompletionpage.trackWarehouseDelivery();
		log.info("################### End Track WareHouse Delivery Task Completion ###################");
		myworkpage.logOff();
	...
	public void acceptanceERSByOdmUserISTrack() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		log.info("################### Start Acceptance ERS Task Completion ###################");
		taskcompletionpage.acceptanceERS();
		log.info("################### End Acceptance ERS Task Completion ###################");
		myworkpage.logOff();
	}
	
	@Test(priority=6)
	public void checkRFS_RFBAndSRTMessage() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException
	{
		log.info("################### Start login in Guardian Application ###################");
		guardianloginpage.LoginMyTools(prop.getProperty("username"), prop.getProperty("password"));
		log.info("################### End login in Guardian Application ###################");
