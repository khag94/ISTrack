...
public class ISTrackERSDirectOrderProcessingAMTestCase extends TestBase {
	public static final Logger log =Logger.getLogger(ISTrackERSDirectOrderProcessingAMTestCase.class.getName());
	...
	public ISTrackERSDirectOrderProcessingAMTestCase()
	{
		super();
	}
	...
	public void newCaseGeneration() throws Throwable
	{
		...
		myworkpage.captureTaskNamesERSOrderAndSelectCheckbox();
