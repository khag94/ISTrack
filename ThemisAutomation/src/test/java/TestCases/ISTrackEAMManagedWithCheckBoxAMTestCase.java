...
public class ISTrackEAMManagedWithCheckBoxAMTestCase extends TestBase {
	...
	public ISTrackEAMManagedWithCheckBoxAMTestCase()
	{
		super();
	}
	...
	public void newCaseGeneration() throws Throwable
	{
		...
		myworkpage.captureTaskNamesEAMManagedAndSelectCheckBox();
	...
	public void taskCompletion() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException, ParseException
	{
		...
		log.info("################### Starting Completion of OnsiteIntervention Task ###################");
		taskcompletionpage.searchCase();
